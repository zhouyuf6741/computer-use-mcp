...
# Test functions for old API compatibility
def test_old_api_functions():
    """Test that old API functions exist but may not work with current pygetwindow."""
    try:
        # These functions use the old API that we've updated
        print("Note: This file contains the old API implementation for reference")
        print("The main code has been updated to work with newer pygetwindow API")
        return True
    except Exception as e:
        print(f"Error: {e}")
        return False
...
if __name__ == "__main__":
    print("This file contains the old API implementation for reference only.")
    print("Use the updated functions in core.py for production use.")
